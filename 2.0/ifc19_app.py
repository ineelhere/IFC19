...
st.sidebar.success("**RECOGNITION: This webapp has been included in one of the Weekly Roundups on Streamlit community forum under the Geography and Society section: [https://discuss.streamlit.io/t/weekly-roundup-streamlit-books-seogres-metrics-dashboards-and-more/16468](https://discuss.streamlit.io/t/weekly-roundup-streamlit-books-seogres-metrics-dashboards-and-more/16468)**")
st.sidebar.markdown("""
